...
namespace His.Negocio
{
    public class NegImagen
    {
        ...
        public static void saveInformeAgendamiento(string[] p, List<PedidoImagen_diagnostico> x, Int64 id)
        {
            new DatImagen().saveInformeAgendamiento(p, x, id);
        }
        ...
        public static DataTable getInterconsultas(int ate_codigo)
        {
