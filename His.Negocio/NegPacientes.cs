...
namespace His.Negocio
{
    public class NegPacientes
    {
        ...
        public static PACIENTES RecuperarPacienteID(int codPaciente)
        {
        ...
        public static DataTable getAtencionesIngresos(string desde, string hasta, bool ingreso, bool alta, bool facturacion, bool Fingreso, int Cod_Ingreso, bool Ftratamiento, int Cod_Tratamiento, bool Fhc, int hc, bool Festado)
        {
            return new DatPacientes().getAtencionesIngresos(desde, hasta, ingreso, alta, facturacion, Fingreso, Cod_Ingreso, Ftratamiento, Cod_Tratamiento, Fhc, hc, Festado);
        }
