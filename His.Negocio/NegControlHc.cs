...
namespace His.Negocio
{
    public class NegControlHc
    {
        ...
        public DataTable PorFecha(string fechainicio, string fechafin)
        {
            DataTable Tabla = new DataTable();
            Tabla = Datos.ControlPorFecha(fechainicio, fechafin);
            return Tabla;
        }
        public DataTable PorFechaAlta(string fechainicio, string fechafin)
        {
            DataTable Tabla = new DataTable();
        ...
        public DataTable PorFechayHc(string fechainicio, string fechafin, string hc)
        {
            DataTable Tabla = new DataTable();
            Tabla = Datos.ControlPorFechayHc(fechainicio, fechafin, hc);
            return Tabla;
        }
        public DataTable PorFechaAltayHc(string fechainicio, string fechafin, string hc)
        {
            DataTable Tabla = new DataTable();
            Tabla = Datos.ControlPorFechaAltayHc(fechainicio, fechafin, hc);
            return Tabla;
        }
        public DataTable PorFechayEstado(string fechainicio, string fechafin, string estado)
        {
            DataTable Tabla = new DataTable();
            Tabla = Datos.ControlPorFechayEstado(fechainicio, fechafin, estado);
            return Tabla;
        }
        public DataTable PorFechaAltayEstado(string fechainicio, string fechafin, string estado)
        {
            DataTable Tabla = new DataTable();
        ...
        public DataTable PorFechaHCEstado(string fechainicio, string fechafin, string hc, string estado)
        {
            DataTable Tabla = new DataTable();
            Tabla = Datos.ControlPorFechaHCEstado(fechainicio, fechafin, hc, estado);
            return Tabla;
        }
        public DataTable PorFechaAltaHCEstado(string fechainicio, string fechafin, string hc, string estado)
        {
            DataTable Tabla = new DataTable();
