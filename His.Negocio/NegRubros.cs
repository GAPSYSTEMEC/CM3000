...
namespace His.Negocio
{
    public  class NegRubros
    {
      ...
      public static bool ParametroGarantia()
        ...
        public static DataTable getCuentas(DateTime desde, DateTime hasta, bool ingreso, bool alta, string hc)
        {
            return new DatRubros().getCuentas(desde, hasta, ingreso, alta, hc);
        }
    }
}
