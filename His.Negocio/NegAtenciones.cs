...
namespace His.Negocio
{
    public class NegAtenciones
    {
        ...
        public static List<ATENCIONES> listaAtencionesPaciente(int codPaciente)
        {
        ...
        public static ATENCIONES AtencionID(int codAtencion)
        {
            return new DatAtenciones().AtencionID(codAtencion);
        }

        //Recupera los datos de la atencion
        public static DataTable CodigoConvenio(int CodigoAtencion)
        {
        ...
        public static DataTable Atencion(int ate_codigo)
        {
        ...
        public static DataTable RegistroAdmision1(Int64 ate_codigo)
        {
            return new DatAtenciones().RegistroAdmision1(ate_codigo);
        }
