...
namespace His.Negocio
{
    public class NegPedidos
    {
        ...
        public static void crearDetallePedido(PEDIDOS_DETALLE ndetalle, PEDIDOS pedido, Int16 Rubro, Int32 PedidoDivision, string NumValue)
        {
            DatPedidos.quirofano = true;
            new DatPedidos().crearDetallePedido(ndetalle, pedido, Rubro,PedidoDivision, NumValue);
        }
            ...
            Int32 PedidoDivision, string NumVale)
        {
            new DatPedidos().GuardarPedidoHonorario(pdd_codigo, ped_codigo, codpro, despro,
                pdd_cantidad, pdd_valor, pdd_iva, pdd_total, pedido, Rubro, PedidoDivision, NumVale);
        }
        ...
        public static DataTable Devoluciones(DateTime desde, DateTime hasta)
        {
            return new DatPedidos().Devoluciones(desde, hasta);
        }
