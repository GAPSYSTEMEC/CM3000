...
namespace His.Negocio
{
    public class NegHabitaciones
    {
        ...
        public static void CambiarEstadoHabitacion(HABITACIONES mHabitacion)
        {
            new DatHabitaciones().CambiarEstadoHabitacion(mHabitacion);
        }

        public static void CambiaEstadoHabitacion(Int64 ateCodigo)
        {
            new DatHabitaciones().CambiaEstadoHabitacion(ateCodigo);
        }
        ...
        public static void SaveMedicosAlta(string medico, Int64 ate_codigo, string observacion, int usuario)
        {
