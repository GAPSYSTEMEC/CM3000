...
namespace His.Negocio
{
    public class NegFactura
    {
        ...
        {
            return new DatFactura().CrearFacturaSic3000(Factura, HistoriaClinica, CodigoAtencion, FacturaPago, EstadoCuenta, CxC, Prefactura, ateCodigo, RucPaciente, nombrePaciente, Direc_Cliente, txt_Telef_P, ATE_FECHA_INGRESO, FechaAlta, Medico);
        }
        ...
        public static DataTable FechaPaciente(int ATE_CODIGO)
        {
        ...
        public static DataTable DatosFacturaDesglose(int CodigoAtencion)
        {
        ...
        public static DataTable DatosFacturaTotal(int CodigoAtencion, string NumeroFactura)
        {
        ...
        public static int ActualizaDescuentoAtencion(int CodigoAtencion)
        {
        ...
        public static bool VerificaAltaPaciente(int ate_Codigo)
        {
        ...
        public static string RecuperaNumeroAtencion(int ateCodigo)
        {
        ...
        public static Boolean RevertirEscCodigo(int ateCodigo)
        {
