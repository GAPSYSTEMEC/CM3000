...
namespace His.Datos
{
    ...
    {
        public void crearEvolucionDetalle(HC_EVOLUCION_DETALLE evDetalle, DateTime fechaInicio, DateTime fechaFin)
        {
        ...
        public List<HC_EVOLUCION_DETALLE> listaNotasEvolucion(int codEvolucion)
        {
            using (var contexto = new HIS3000BDEntities(ConexionEntidades.ConexionEDM))
            {
        ...
        public EVOLUCIONDETALLE ultimaNotaEvolucion(int codEvolucion)
        {
            //using (var contexto = new HIS3000BDEntities(ConexionEntidades.ConexionEDM))
            //{
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    objDetalle.evd_codigo = Convert.ToInt16(dr["EVD_CODIGO"].ToString());
        ...
        public DataTable RecuperaPrescripciones(int EVD_CODIGO)
        {
            SqlConnection Sqlcon;
            SqlCommand Sqlcmd;
            SqlDataAdapter Sqldap;
        ...
        public void editarNotaEvolucionMedica(string notaModificada, DateTime fechaInicio, DateTime fechaFin, int evd_codigo, string docs)
        {
            using (var contexto = new HIS3000BDEntities(ConexionEntidades.ConexionEDM))
            {
