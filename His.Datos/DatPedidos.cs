...
namespace His.Datos
{
    public class DatPedidos
    {
        ...
        public Int64 ultimoCodigoPedidosDetalles()
        {
            using (var contexto = new HIS3000BDEntities(ConexionEntidades.ConexionEDM))
            {
                var lista = (from p in contexto.PEDIDOS_DETALLE
                             select p.PDD_CODIGO).ToList();
        ...
        public void crearDetallePedido(PEDIDOS_DETALLE ndetalle, PEDIDOS pedido, Int16 Rubro,Int32 PedidoDivision, string NumVale)
        {
            try
            {
                using (var contexto = new HIS3000BDEntities(ConexionEntidades.ConexionEDM))
        ...
        public void GuardarPedidoHonorario(Int64 pdd_codigo, Int64 ped_codigo, string codpro, string despro, 
            ...
            Int32 PedidoDivision, string NumVale)
        {
            SqlCommand command;
            SqlConnection connection;
            BaseContextoDatos obj = new BaseContextoDatos();
            connection = obj.ConectarBd();
            connection.Open();
            command = new SqlCommand("INSERT INTO PEDIDOS_DETALLE VALUES(@pdd_codigo, @ped_codigo, @codpro, @despro, @pdd_cantidad, @pdd_valor, @pdd_iva, @pdd_total, 1, 0, NULL, 0, NULL, NULL, @codpro)", connection);
        ...
        public DataTable MonitorPedidos(DateTime fechainicio, DateTime fechafin)
        {
            ...
            string xWhere = "WHERE P.PED_FECHA BETWEEN @FechaInicio AND @FechaFin ORDER BY P.PED_FECHA DESC";
