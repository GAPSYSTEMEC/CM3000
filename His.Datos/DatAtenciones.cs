...
namespace His.Datos
{
    public class DatAtenciones
    {
        ...
        //recupera notas de evoluvion Pablo Rocha 30-05-2020
        ...
        public ATENCIONES AtencionID(int codigo)
        {
        ...
        public DataTable CodigoConvenio(int AtencionCodigo)
        {
            SqlConnection Sqlcon;
            SqlCommand Sqlcmd;
            SqlDataAdapter Sqldap;
        ...
        public List<ATENCIONES> listaAtencionesPaciente(int codPaciente)
        {
            using (var contexto = new HIS3000BDEntities(ConexionEntidades.ConexionEDM))
            {
                return (from a in contexto.ATENCIONES
        ...
        public DataTable Atencion(int ate_codigo)
        {
        ...
        public DataTable RegistroAdmision1(Int64 ate_codigo)
        {
            SqlCommand command;
            SqlDataReader reader;
            SqlConnection connection;
            ...
            command = new SqlCommand("ADMISIONES1", connection);
            command.CommandType = CommandType.StoredProcedure;
