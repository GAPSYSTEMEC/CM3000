...
namespace His.Datos
{
    public class DatFactura
    {
        ...
        public int GuardaDescuentoProductos(Int32 PcodRubro, string PCodpro, double Pdescuento, double Pporcentaje, Int64 PCueCodigo, Int32 Patencion)
        {
            ...
            Sqlcmd.Parameters.Add("@Atencion", SqlDbType.SmallInt);
        ...
        public DataTable FechaPaciente(int ATE_CODIGO)
        {
        ...
        public DataTable DatosFacturaDesglose(int CodigoAtencion)
        {
            SqlConnection Sqlcon;
            SqlCommand Sqlcmd;
            SqlDataAdapter Sqldap;
        ...
        public DataTable DatosFacturaTotal(int CodigoAtencion, string NumeroFactura)
        {
            SqlConnection Sqlcon;
            SqlCommand Sqlcmd;
            SqlDataAdapter Sqldap;
        ...
        public bool VerificaAltaPaciente(int ate_codigo)
        {
            bool ok = true;
            try
            {
        ...
        public int ActualizaDescuentoAtencion(int CodigoAtencion)
        {
        ...
        public void GuardaCambiosFactura(Int64 CodigoAtencion, DataTable ListaItems, int coddepartamento)
        {
            ...
            foreach (DataRow Item1 in ListaItems.AsEnumerable())
            {
                ...
                {
                    string codpro = Item1[1].ToString();
                    ...
                    if (parametro)
                    {
                        ...
                        else if (claspro != "B" && coddepartamento == 7)
                        {
                            Sqlcmd = new SqlCommand("sp_ActualizaValoresCuentas", Sqlcon);
                            Sqlcmd.CommandType = CommandType.StoredProcedure;
        ...
        public string RecuperaNumeroAtencion(int ateCodigo)
        {
            try
            {
                using (var contexto = new HIS3000BDEntities(ConexionEntidades.ConexionEDM))
        ...
        public Boolean RevertirEscCodigo(int ateCodigo)
        {
            Boolean ok = false;
            try
            {
