...
namespace His.Datos
{
    public class DatHonorariosMedicos
    {
            ...
            int tif_codigo, string lote, string numControl)
        {
            ...
            string sql = "SELECT * FROM HONORARIOS_VISTA  V\r\n" +
                "inner join FORMA_PAGO fp on v.FOR_CODIGO = fp.FOR_CODIGO inner join Sic3000..Forma_Pago sfp on fp.forpag = sfp.forpag WHERE \r\n";
            string FiltroFechas = "HOM_FACTURA_FECHA BETWEEN '" + fechaInicio + "' AND '" + fechaFin + "'\r\n";
            string FiltroMedico = "MED_CODIGO = " + med_codigo;
            string FiltroPago = "sfp.forpag = " + for_codigo;
