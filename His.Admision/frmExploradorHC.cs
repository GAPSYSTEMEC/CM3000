        ...
        private void ultraExplorerBar1_ItemClick(object sender, Infragistics.Win.UltraWinExplorerBar.ItemEventArgs e)
        {
            switch(e.Item.Key.ToString())
            {
                case "AdmisionAltaEgreso":
                    ...
                    break;
                case "Anamnesis":
                    frm_Anemnesis anemeasis = new frm_Anemnesis(codigoAtencion,false);
                ...
                case "Epicrisis":
                    ...
                    break;
                case "Imagen":
                    frm_Imagen imagen = new frm_Imagen(codigoAtencion);
                    imagen.MdiParent = this;
                    imagen.Show();
                    break;
                case "Referencia":
                    frm_Referencia x = new frm_Referencia(codigoAtencion);
                    x.MdiParent = this;
                    x.Show();
                    break;
                case "Contrareferencia":
                    frm_Contrareferencia x1 = new frm_Contrareferencia(codigoAtencion);
                    x1.MdiParent = this;
                    x1.Show();
                    break;
                case "ProtocoloDeOperacion":
                    ...
                    break;
                case "Emergencia":
                    frm_Emergencia emergencia = new frm_Emergencia(codigoAtencion);
                ...
                case "Interconsulta":
                    ...
                    break;
                case "Laboratorio":
                    frmLaboratorioClinico laboratorio = new frmLaboratorioClinico(codigoAtencion, true);
