                ...
                if (resultado == MessageBoxResult.Yes)
                {
                    try
                    {
                        ...
                        var habitacionDetalle = new HABITACIONES_DETALLE
                        {
                            ...
                            HABITACIONESReference =
                                                        {EntityKey = habitacionSelecionada.EntityKey},
                        ...
                        NegHabitacionesHistorial.HabHistorialArea(Atencion.ATE_CODIGO, hah_codigo);
                        ...
                        NegHabitaciones.CambiaEstadoHabitacion(this.Atencion.ATE_CODIGO);
