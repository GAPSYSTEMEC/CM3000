    ...
    public partial class frmAyudaProductos : Form
    {
        ...
        private void cargarProductos()
        {
            ...
            try
            {
                ...
                if (listartodos)
                {
                    Productos = NegProducto.RecuperarProductosListaSPall(1, ""/*txtBuscar.Value.ToString()*/, 0, His.Parametros.FacturaPAR.BodegaPorDefecto, _CodigoEmpresa, _CodigoConvenio);
                }else if (_Rubro == null)
                {
                    Productos = NegProducto.RecuperarProductosListaSPPedidosAreas(1, ""/*txtBuscar.Value.ToString()*/, 0, His.Parametros.FacturaPAR.BodegaPorDefecto, _CodigoEmpresa, _CodigoConvenio, areas.PEA_CODIGO);
                }
                else
                {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (listartodos)
                {
                    Productos = NegProducto.RecuperarProductosListaSPall(1, txt_Nombre.Text.ToString(), 0, His.Parametros.FacturaPAR.BodegaPorDefecto, _CodigoEmpresa, _CodigoConvenio);
                }
                else if (_Rubro == null)
                {
                    Productos = NegProducto.RecuperarProductosListaSPPedidosAreas(1, txt_Nombre.Text.ToString(), 0, His.Parametros.FacturaPAR.BodegaPorDefecto, _CodigoEmpresa, _CodigoConvenio, areas.PEA_CODIGO);
                }
                else
                {
                    Productos = NegProducto.RecuperarProductosListaSP(1, txt_Nombre.Text.ToString(), _Rubro.RUB_CODIGO, His.Parametros.FacturaPAR.BodegaPorDefecto, _CodigoEmpresa, _CodigoConvenio);
                }
