        ...
        
{
        ...
        private void btnNewAtencion_Click(object sender, EventArgs e)
        {
            ...
            if (auxx.Rows[0][0].ToString().Trim() == "0")
            {
                ...
                limpiarCamposPreAtencion();
                habilitarCamposPreAtencion();
                atencionReal = Convert.ToInt16(txt_numeroatencion.Text) - 1;
            }
            else
            {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (validarFormulario() == true)
            {
                ...
                {
                    NegAtenciones.actualizaEscCodigoPreadmision(Convert.ToInt16(txt_numeroatencion.Text), 14);
                }
                else
                {
                    NegAtenciones.actualizaEscCodigoPreadmision(Convert.ToInt16(txt_numeroatencion.Text), 1);
                }
        ...
        private bool validarFormulario()
        {
            try
            {
                ...
                if ((DateTime.Now.Year - dtp_fecnac.Value.Year) >= 0 && (DateTime.Now.Year - dtp_fecnac.Value.Year) <= 17) //Menor de Edad
                {
                    ...
                    {
                        erroresPaciente.SetError(txt_nombreAcomp, "Paciente menor de edad, agregue datos del acompañante.");
                        valido = false;
                    }
        ...
        private void form001ADMISIONYALTAEGRESOToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    //string path = medico.path();

                    //DSAdmision Admision = new DSAdmision();
                    //DSAdmisionCambios Cambios = new DSAdmisionCambios();
                    //DsRegistroAdmision Registro = new DsRegistroAdmision();
                    ...
                    //drAdmision["Hc"] = txt_historiaclinica.Text.Trim();
                    //drAdmision["Apellido1"] = txt_apellido1.Text.Trim();
                    //drAdmision["Apellido2"] = txt_apellido2.Text.Trim();
                    //drAdmision["Nombre1"] = txt_nombre1.Text.Trim();
                    //drAdmision["Nombre2"] = txt_nombre2.Text.Trim();
                    //drAdmision["Identificacion"] = pacienteActual.PAC_IDENTIFICACION.Trim();
                    //drAdmision["Direccion"] = txt_direccion.Text.Trim();
                    ...
                    //drAdmision["F_Nacimiento"] = pacienteActual.PAC_FECHA_NACIMIENTO;
                    //drAdmision["L_Nacimiento"] = "";
                    ...
                    //drAdmision["Admisionista"] = "";
                    //drAdmision["F_Admision"] = datosPacienteActual.DAP_FECHA_INGRESO;
                    ...
                    //for (int i = 0; i < 10; i++)
                    //{
                    //    drRegistro = Registro.Tables["Registros"].NewRow();
                    //    drRegistro["N1"] = Registro1.Rows[i]["N_ORDEN"].ToString();
                    //    drRegistro["Fecha1"] = Registro1.Rows[i]["FECHA_INGRESO"].ToString();
                    //    drRegistro["Edad1"] = Registro1.Rows[i]["EDAD"].ToString();
                    //    drRegistro["Referido1"] = Registro1.Rows[i]["REFERIDO_DE"].ToString();
                    //    drRegistro["Primera1"] = Registro1.Rows[i]["PRIMERA"].ToString();
                    //    drRegistro["Sub1"] = Registro1.Rows[i]["SUBSEC"].ToString();
                    //    drRegistro["Admisionista1"] = Registro1.Rows[i]["COD_ADMISIONISTA"].ToString();
                    //    drRegistro["N2"] = Registro2.Rows[i]["N_ORDEN"].ToString();
                    //    drRegistro["Fecha2"] = Registro2.Rows[i]["FECHA_INGRESO"].ToString();
                    //    drRegistro["Edad2"] = Registro2.Rows[i]["EDAD"].ToString();
                    //    drRegistro["Referido2"] = Registro2.Rows[i]["REFERIDO_DE"].ToString();
                    //    drRegistro["Primera2"] = Registro2.Rows[i]["PRIMERA"].ToString();
                    //    drRegistro["Sub2"] = Registro2.Rows[i]["SUBSEC"].ToString();
                    //    drRegistro["Admisionista2"] = Registro2.Rows[i]["COD_ADMISIONISTA"].ToString();
                    //    drRegistro["Identificacion"] = pacienteActual.PAC_IDENTIFICACION;

                    //    Registro.Tables["Registros"].Rows.Add(drRegistro);
                    //}

                    //foreach (DataRow item in Cambios1.Rows)
                    //{
                    //    drCambios = Cambios.Tables["Cambios"].NewRow();
                    ...
                    //    drCambios["Identificacion"] = pacienteActual.PAC_IDENTIFICACION;

                    //    Cambios.Tables["Cambios"].Rows.Add(drCambios);
                    //}
                    //Formulario.frmReportes x = new Formulario.frmReportes(1, "Admision", Admision, Registro, Cambios);
                    //x.ShowDialog();
                }
