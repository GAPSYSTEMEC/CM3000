                ...
                if (txtobservacion.Text != "")
                {
                    if (ultimaAtencion.ESC_CODIGO == 1)
                    {
                        if (MessageBox.Show("¿Desea dar de alta a paciente?", "HIS3000", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
                        {
                            ...
                            {
                                MessageBox.Show("Paciente ha sido de alta.", "HIS3000", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                ...
                                if (txtobservacion.Text != "")
                                {
                                    ...
                                    {
                                        NegHabitaciones.SaveMedicosAlta(item.Cells[0].Value.ToString(), AteCodigo, txtobservacion.Text, Sesion.codUsuario);
                                    }
                                }
                            }
                            else
