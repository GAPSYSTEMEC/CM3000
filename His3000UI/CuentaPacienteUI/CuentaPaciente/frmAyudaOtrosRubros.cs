...
namespace CuentaPaciente
{
    public partial class frmAyudaProductos : Form
    {
        ...
        private void addProducto()
        {
            ...
            if (gridProductos.CurrentRow != null)
            {
                ...
                if (cantidad > 0)
                {
                    ...
                    cantidadReal = NegHabitaciones.VerificaCantidadStock(Convert.ToInt64(Item.Cells["CODIGO"].Value), His.Parametros.FacturaPAR.BodegaPorDefecto);
        ...
        private void btn_Aceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (item.Cells["DESCRIPCION"].Value.ToString() == "HONORARIOS MEDICOS")//Cambios Edgar 20210208 para pruebas 
                {
        ...
        private void gridProductosSeleccionados_DoubleClickRow(object sender, DoubleClickRowEventArgs e)
        {
            ...
            if (gridProductosSeleccionados.Selected.Rows.Count > 0 && gridProductosSeleccionados.ActiveRow.Cells["DESCRIPCION"].Value.ToString() == "HONORARIOS MEDICOS")
            {
                gbxDetalleHonorarios.Visible = true;
