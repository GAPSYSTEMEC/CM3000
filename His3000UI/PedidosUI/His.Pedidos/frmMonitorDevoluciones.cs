...
namespace His.Pedidos
{
    public partial class frmMonitorDevoluciones : Form
    {
        ...
        public void Buscar()
        {
            ...
            {
                UltraGridDevoluciones.DataSource = NegPedidos.Devoluciones(dtpDesde.Value, dtpFiltroHasta.Value.AddHours(23).AddMinutes(59).AddSeconds(59));
            }
            else
            {
                UltraGridDevoluciones.DataSource = NegPedidos.Devoluciones(DateTime.Now.Date, dtpFiltroHasta.Value.AddHours(23).AddMinutes(59).AddSeconds(59));
            }
        }
