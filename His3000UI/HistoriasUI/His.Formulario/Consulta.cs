...
namespace His.Formulario
{
    public partial class Consulta : Form
    {
        ...
        public Consulta(int ateCodigo, string hc, bool explo)
        {
            InitializeComponent();
            inicializarGridPrescripciones();
            txt_horaAltaEmerencia.Text = DateTime.Now.ToShortTimeString();
            ...
            txtatecodigo.Text = ateCodigo.ToString();
            txthistoria.Text = hc;
            paciente = NegConsultaExterna.RecuperaPaciente(ateCodigo);
        ...
        public void ControlesTab(bool estado)
        {
            grpPrimerGrupo.Enabled = estado;
        ...
        public bool Valida()
        {
            ...
            {
                ValidaError(txtindicaciones, "INGRESE INDICACIONES DE EVOLUCIÓN");
                validar = false;
            }
            return validar;
        }
        ...
        private void chbPre4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                chbPre4.Checked = false; chbDef4.Checked = false;
            }
        }
        ...
        {
            toolStripButton6.Enabled = nuevo;
            btnGuardar.Enabled = guardar;
            buttonImprimir.Enabled = imprimir;
        }
        ...
        private void buttonImprimir_Click(object sender, EventArgs e)
        {
            ...
            Ds.Tables[0].Rows.Add
                (new object[]
                {
                    ...
                    datos.sexoPaciente.ToString(),
                    datos.edadPaciente= lblEdad.Text,
                    datos.historiaClinica= lblHistoria.Text.Trim(),
                    datos.ateCodigo= lblAteCodigo.Text,
                    datos.motivoConsulta=txtMotivo.Text,
                    datos.antecedentesPersonales = txtAntecedentesPersonales.Text,
                    datos.cardiopatia.ToString(),
        ...
        #region CAMBIOS EDGAR 20210407
        private void refrescarSolicitudes()
        {
            gridSol.DataSource = NegConsultaExterna.getConsultaExterna(ate_codigo);
        ...
        {
            DialogResult dialogResult = MessageBox.Show("¿Desea cargar la Consulta Externa?", "HIS3000", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
            if (dialogResult == DialogResult.Yes)
            {
                limpiaCampos();
                id_form002 = Convert.ToInt32(gridSol.Rows[gridSol.CurrentRow.Index].Cells["ID"].Value.ToString());
                CargarPaciente();
