...
namespace His.Formulario
{
    public partial class frm_Imagen : Form
    {
        ...
        private PedidoImagen_reporte empaquetarReporteCabecera(int idImagenologia)
        {
            ...
            repor.cod_medico = Convert.ToString(e.Rows[0]["COD_medico"]);
        ...
        private void btnImprimirIndividual_Click(object sender, EventArgs e)
        {
            if (gridSol.RowCount > 0)
            {
                ImprimirReporte(Convert.ToInt32(gridSol.Rows[gridSol.CurrentRow.Index].Cells["id"].Value.ToString()));
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.txtResumen.Appearance = appearance1;
            ...
            // txtCODRadiologo
            // 
            this.txtCODRadiologo.Location = new System.Drawing.Point(311, 4);
            ...
            // txtCODTecnologo
            // 
            this.txtCODTecnologo.Location = new System.Drawing.Point(267, 7);
            ...
            // txtMedicoCOD
            // 
            this.txtMedicoCOD.Location = new System.Drawing.Point(219, 4);
