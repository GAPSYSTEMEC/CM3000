...
namespace TarifariosUI
{
    public partial class frmCrearHonorarios : Form
    {
        ...
        public frmCrearHonorarios(Int32 codPac, Int32 codMedico)
        {
            InitializeComponent();
        ...
        private void txtCodigoPaciente_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (txtCodigoPaciente.Text != "")
                {
                    ...
                    ultimaAtencion = NegAtenciones.RecuperarUltimaAtencion(Convert.ToInt32(txtCodigoPaciente.Text));
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (His.Entidades.Clases.Sesion.codMedico != 0)
            {
                try
                {
                    ...
                    guardado = true;                    
                    NegTarifario.GuardaHonorarioCuentaPaciente(txtAtencion.Text, txtTotal.Text, txtmedico.Text, Sesion.codUsuario, honTarifario.HON_FECHA);
