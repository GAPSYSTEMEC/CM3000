   ...
   public  class Atencion
    {
        ...
        public DataTable CuentaPaciente(Int64 ateNumero)
        {
            ...
            string sql = "select round(SUM((CUE_VALOR_UNITARIO * CUE_CANTIDAD)+CUE_IVA),2) as TOTAL from CUENTAS_PACIENTES where CUE_CANTIDAD <> 0 AND CUE_ESTADO=1 AND ATE_CODIGO=(select Ate_codigo from atenciones where ate_numero_atencion=" + ateNumero + ")";
        ...
        public DataTable FacturaElectronicaFisica(string caja)
        {
            ...
            string sql = "select idTipoFact from Sic3000..autorizacion where caja='" + caja + "'";
