    ...
    public partial class frm_Medicos : Form
    {
        ...
        private void GrabarDatos()
        {
            try
            {
                ...
                //        }
                //        else
                //            MessageBox.Show("El código ya existe. Ingrese otro código", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
                //    }
        ...
        private void MedicoGuarda()
        {
            ...
            medicoModificada.MED_CUENTA_CONTABLE = "";
        ...
        private void guardarMedicos()
        {
            try
            {
                ...
                if (resultado == DialogResult.Yes)
                {
                    ...
                    USUARIOS consultaususario =
                        NegUsuarios.RecuperaUsuarios().Where(p => p.ID_USUARIO == Sesion.codUsuario).
                            FirstOrDefault();
                    ...
                    if (consultaususario == null || medicoModificada.ID_USUARIO == 0)
                    {
                        ...
                        NegUsuarios.CrearUsuario(DatosUsuario);
                        medicoModificada.ID_USUARIO = DatosUsuario.ID_USUARIO;
                    ...
                    if (txt_cuentacontable.Text.Trim() == string.Empty)
                        medModificada.MED_NUM_CUENTA = "000000000";
                    else
                        medModificada.MED_CUENTA_CONTABLE = medicoModificada.MED_CUENTA_CONTABLE;
                    medModificada.MED_TELEFONO_CASA = medicoModificada.MED_TELEFONO_CASA;
                    medModificada.MED_TELEFONO_CONSULTORIO = medicoModificada.MED_TELEFONO_CONSULTORIO;
                    ...
                    if (ckbDepurado.Checked)
                        ...
                        medModificada.MED_CODIGO_LIBRO = medicoModificada.MED_CODIGO_LIBRO;
                    ...
                    else
                    {
                        ...
                        ESTADO_CIVIL estcivilOriginal = NegEstadoCivil.RecuperaEstadoCivil().Where(esc => esc.ESC_CODIGO == medicoOriginal.ESC_CODIGO).FirstOrDefault();
                        medOrigen.ESTADO_CIVILReference.EntityKey = estcivilOriginal.EntityKey;
        ...
        private void btnExportarExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (PathExcel != null)
                {
                    this.ultraGridExcelExporter1.Export(gridx, PathExcel);
        ...
        private void txt_medruc_Leave_1(object sender, EventArgs e)
        {
            ...
            {
                if (txt_medruc.Text.ToString() != string.Empty)
                {
                    try
                    {
