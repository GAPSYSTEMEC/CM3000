    ...
    public partial class frm_IngresoHonorarios : Form
    {
        ...
        public void cargarHonorario(int codigoHonorario)
        {
            try
            {
                ...
                {
                    string numrec = NegHonorariosMedicos.RecuperarNUMREC(Convert.ToInt32(codigoHonorario));
                    if (numrec != "")
        ...
        private void ayudaPacientes_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txtFactura.Text != "   -   -")
                {
                    ...
                    dts_cuenta = obj_atencion.CuentaPaciente(Convert.ToInt64(txtnumatencion.Text.Trim()));
                    ...
                    if (honorarioaBorrar.HOM_VALOR_PAGADO == 0)
                    {
                        if (e.Cell.Column == ultraGrid.DisplayLayout.Bands[0].Columns["delete"])
                        {
                            ...
                            if (op == DialogResult.OK)
                            {
                                ...
                                NegHonorariosMedicos.CrearHonorarioAuditoria(honorarioaBorrar, (bool)ultraGrid.ActiveRow.Cells["POR_FUERA"].Value, false, "ELIMINADO", Caja(), (double)honorarioaBorrar.VALOR, Convert.ToInt64(ultraGrid.ActiveRow.Cells["MED_CODIGO"].Value));
