...
namespace His.Dietetica
{
    public partial class frmQuirofanoAgregarProducto : Form
    {
        ...
        {
            //ultraGridProducto.DataSource = Quirofano.CargarTablaProductos("", false, true);
            ultraGridProducto.DataSource = NegQuirofano.Productos();
            RedimencionarTabla();
        ...
        {
            string producto = NegQuirofano.SoloProductoRepetido(codpro);
            if(cmbTipo.SelectedIndex != -1 && txtDesc.Text != "")
            {
                try
                {
                    if(Editar == false)
                    {
                        ...
                        {
                            NegQuirofano.AgregarProducto(codpro, cmbTipo.GetItemText(cmbTipo.SelectedItem));
