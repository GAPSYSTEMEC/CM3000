    ...
    public partial class frmQuirofanoExplorador : Form
    {
        ...
        public void CargarProcedimientos()
        {
            try
            {
                ...
                cmbProcedimiento.ValueMember = "PCI_CODIGO";
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void toolStripButtonActualizar_Click(object sender, EventArgs e)
        {
            ...
            if(UltraGridPacientes.Selected.Rows.Count > 0)
            {
                    ...
                    MessageBoxIcon.Exclamation) == DialogResult.Yes)
                {
                    ...
                    frmQuirofanoRegistro.seguro = Fila.Cells[9].Value.ToString();
                    frmQuirofanoRegistro.tratamiento = Fila.Cells[10].Value.ToString();
                    frmQuirofanoRegistro.referido = Fila.Cells[12].Value.ToString();
